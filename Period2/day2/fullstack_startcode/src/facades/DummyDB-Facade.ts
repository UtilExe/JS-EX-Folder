...
class FriendsFacade {
    ...
    async getAllFriends(): Promise<Array<IFriend>> {
        ...
        return arrayValuePromise<IFriend>(this.friends); // håndterer at det er asynkront. returnerer en promise.
    }
    async getFriend(friendEmail: string): Promise<IFriend | null> {
        ...
        return singleValuePromise<IFriend>(friend); // håndterer at det er asynkront. returnerer en promise.
    }
}
